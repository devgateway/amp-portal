...
*/
add_action( 'init', 'tcdi_post_carousel' );

function tcdi_post_carousel() {
 ...
 */
function tcdi_post_carousel_register_block() {
    $name='post-carousel';
...
add_action( 'init', 'tcdi_post_carousel_register_block' );
