    ...
    case LOAD_MENU_DONE:
      {
        ...
        return state.setIn(['menu', slug, 'loading'], false).deleteIn(['menu', slug, 'error']).setIn(['menu', slug, 'menu'], data);
      }
    ...
    case LOAD_POSTS_DONE:
      {
        ...
        return state.setIn([store, 'loading'], false).deleteIn([store, 'error']).setIn([store, "items"], data);
      }
    ...
    case LOAD_CUSTOM_POSTS_BY_TAXONOMY_DONE:
      {
        ...
        return state.setIn([wpType, taxonomy, category, 'loading'], false).deleteIn([wpType, taxonomy, category, 'error']).setIn([wpType, taxonomy, category, 'items'], data);
      }
    ...
    case LOAD_PAGES_DONE:
      {
        ...
        return state.setIn(['pages', store, 'loading'], false).deleteIn(['pages', store, 'error']).setIn(['pages', store, 'items'], data);
      }
    ...
    case LOAD_PAGES_ERROR:
      {
        ...
        return state.setIn(['pages', store, 'loading'], false).setIn(['pages', store, 'error'], action.error);
      }
    ...
    case CLEAN_PAGE_DATA:
      {
        ...
        return state.setIn(['pages', store, 'loading'], true).deleteIn(['pages', store, 'error']).deleteIn(['pages', store, 'items']);
      }
